...
public class risk_commit extends tms_worker_proxy<run_db_commit> {
	...
	/* (non-Javadoc)
	 * @see cn.com.higinet.tms35.core.concurrent.tms_worker_base#request(java.lang.Object)
	 */
	@Override
...
//		dao_acc m_dao_acc;
		...
		/* (non-Javadoc)
		 * @see cn.com.higinet.tms35.core.concurrent.tms_worker_base#post_run()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see cn.com.higinet.tms35.core.concurrent.tms_worker_base#pre_run()
		 */
		@Override
