package cn.com.higinet.tms.manager.modules.datamgr.service.impl;
...
import cn.com.higinet.tms.manager.modules.datamgr.service.TableOperService;
...
public class CommonTableOperService implements TableOperService {
	...
	public List<Map<String, Object>> queryDataList(DataConfig tableConfig,
			DataConfig dataconfig,String authFlag) {
	 ...
	 * @return
	 */
	private String getFilterCondition(DataConfig tableConfig,
...
//					filterValue = value;
	 ...
	 * @return
	 */
	private String getReferenceCondition(DataConfig tableConfig,
			DataConfig dataconfig){
		String referenceSql = "";
