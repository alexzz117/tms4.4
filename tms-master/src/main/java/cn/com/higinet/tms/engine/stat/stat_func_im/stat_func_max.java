...
public class stat_func_max extends stat_func
{
	...
	public Object union_item(Object w1, Object w2)
	{
		...
		ret.add(new stat_win_D(i1.win_time, Math.max(i1.dV, i2.dV)));
		return ret;
	}
	...
	public String set(String d, db_stat stat, int cur_minute, Object cur_value)
	{
		...
		stat_win_fac<stat_win_D> fac = new stat_win_fac<stat_win_D>(d, min_win_time, stat.dec_win_when_set(),
				stat_win_D._fac);
		stat_win_fac<stat_win_D>.FI fi = fac.find_r(cur_win_time);
		if (fi.flag > 0)
		{
			return fac.toString() + new stat_win_D(cur_win_time, value) //
					.toString(fac.base_time());
		}
		else if (fi.flag == 0)
		{
			if (fi.e.dV < value)
	...
	public Object get(String data, db_stat stat, int cur_minute, Object cur_value)
	{
		...
		String s = data;
		stat_win_fac<stat_win_D> fac = new stat_win_fac<stat_win_D>(s, min_win_time, stat_win_D._fac);
