...
import cn.com.higinet.tms.manager.dao.BaseDao;
import cn.com.higinet.tms.manager.dao.InnerSql;
 ...
 * @see cn.com.higinet.tms.manager.dao.BaseDao
 */
public class BaseDaoImpl implements BaseDao {
	...
	public long count(String sql){
		return this.jdbcTemplate.queryForObject(COUNT_SQL.replaceFirst("\\$\\{SQL\\}", sql), Long.class);
	}
	...
	public long count(String sql, Object... params){
		...
		return this.jdbcTemplate.queryForObject(COUNT_SQL.replaceFirst("\\$\\{SQL\\}", sql), params, Long.class);
	}
	
	public long count(String sql, Map<String, ?> params){
		return this.namedParameterJdbcTemplate.queryForObject(COUNT_SQL.replaceFirst("\\$\\{SQL\\}", sql), params, Long.class);
	}
