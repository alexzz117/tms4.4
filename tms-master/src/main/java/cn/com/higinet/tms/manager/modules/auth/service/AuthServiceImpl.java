...
public class AuthServiceImpl extends ApplicationObjectSupport implements AuthService {
	...
	public Page<Map<String, Object>> authLogList( Map<String, String> reqs ) {
		String sql = "SELECT LOG.*," + " OPER.REAL_NAME,OPER.LOGIN_NAME,FUNC.FUNC_NAME" + " FROM CMC_OPERATE_LOG LOG LEFT JOIN CMC_OPERATOR OPER ON LOG.OPERATOR_ID = OPER.OPERATOR_ID" + " LEFT JOIN TMS_MGR_AUTHLOG AUTHLOG ON AUTHLOG.LOG_ID = LOG.PRIMARY_KEY_ID" + " LEFT JOIN CMC_FUNC FUNC ON FUNC.FUNC_ID = LOG.FUNC_ID"
