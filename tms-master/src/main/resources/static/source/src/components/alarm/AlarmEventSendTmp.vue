  ...
  <div>
    <el-form label-position="right" :model="listForm" ref="listForm" label-width="100px" :inline="inline">
      <el-row>
        ...
        <el-col :span="3">
          <div>
            <el-select v-model="listForm.passtatus" placeholder="请选择" @focus="selectFocus('passtatus')"
                       :clearable="clearable">
              <el-option
      ...
      <el-row>
        <el-col :span="1">
          <div>
            <el-button type="primary" :align="left" icon="el-icon-success" @click="openDialog"
                       :disabled="sendBtnStatus">分派
            </el-button>
          </div>
        </el-col>
      </el-row>
    ...
    <el-table
      ...
      <el-table-column fixed="left" label="操 作" width="90" alert="center">
        <template slot-scope="scope">
          <el-button type="text" @click="" size="mini" icon="el-icon-success" title="分派"/>
          <!--<el-button type="text" @click="" size="mini" icon="el-icon-search" title="查看"/>-->
        </template>
      </el-table-column>
