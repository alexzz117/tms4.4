  ...
  <div>
    <el-row>
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="日期报警信息查询" name="search">
        ...
        <el-collapse-item title="日期报警信息展示图" name="chart">
          <div>
        ...
        <el-collapse-item title="日期报警信息列表" name="table">
          <template slot="title">
          ...
          <div>
            <el-table :data="tableData" style="width: 100%">
              <el-table-column prop="alertdate" label="日期" width="150"/>
  ...
  export default {
    ...
    methods: {
        ...
        for (var i = 0; i < g_list.length; i++) {
          if (op_x_data.length >= cf_tops) {
            ...
            if ((g_index) % 2 === 0) {
              ...
              op_x_data.push(g_list[i]['alertdate'])
            }
      ...
      exportFunc () {
        ...
        console.info(params)
        let url = '/report/date/export?' + util.serializeObj(params)
        ajax.syncGet({
          url: url
        })
