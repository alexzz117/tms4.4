...
public class NPP205Socket {
	...
	public boolean sendMessage(Map<String, Object> map) {
		...
		String msgBody = xml
				+ "<Message><SYNCFLAG>0</SYNCFLAG><TXNCODE>7001200000160756748201</TXNCODE><TXNTIME>2016-07-21 16:40:50</TXNTIME><TXNSTATUS>0</TXNSTATUS><TXNID>NPP205</TXNID><CHANCODE>CH01</CHANCODE><USERID>20191939921964</USERID><DEVICETOKEN>b6101b3940d044039a8e95fa21508ee3</DEVICETOKEN><DISPATCH>20191939921964</DISPATCH></Message>";
		// String msgBody = xml + "";
		int bodyLength = 0;
		try {
	...
	public static void main(String[] args) {
		NPP205Socket ep0001Socket = new NPP205Socket();
