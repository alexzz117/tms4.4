...
public class NPP213Socket {
	...
	public boolean sendMessage(Map<String, Object> map) {
		...
		String msgBody = xml
				+ "<Message><SYNCFLAG>1</SYNCFLAG><TXNCODE>41112000001607299018</TXNCODE><TXNTIME>2016-07-15 13:54:52</TXNTIME><TXNID>NPP213</TXNID><CHANCODE>CH01</CHANCODE><USERID>20139969931983</USERID><DEVICETOKEN>888888</DEVICETOKEN><DISPATCH>20139969931983</DISPATCH><BALANCE>504443.64</BALANCE><AUTHLEVEL>MIDD_AUTH</AUTHLEVEL><RECUSERID>20139969931983</RECUSERID><BUSYSRC>PC</BUSYSRC><BUSYKIND>03</BUSYKIND><PAYAMOUNT>782.0</PAYAMOUNT><PURPOSE>007</PURPOSE><PRODUCTNAME>返佣金</PRODUCTNAME><CURRENCY>RMB</CURRENCY><MERCHNO>1000284988</MERCHNO></Message>";
		// String msgBody = xml + "";
		int bodyLength = 0;
		try {
	...
	public static void main(String[] args) {
		NPP213Socket ep0001Socket = new NPP213Socket();
