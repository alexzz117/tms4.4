...
public class SocketNPP208 {
	 ...
	 * */
	//public String ip = "192.168.100.202";
	//private String ip = "127.0.0.1";
	private String ip = "10.118.201.181";
	...
	public boolean sendMessage(Map<String, Object> map) {
		...
		String msgBody = xml
				+ "<Message><tableName>TMS_COM_RULE</tableName></Message>";
		// String msgBody = xml + "";
		int bodyLength = 0;
		try {
	...
	public static void main(String[] args) {
		for (int n = 0; n < 1; n++) {
			SocketNPP208 ep0001Socket = new SocketNPP208();
