 ...
 * All right reserved.
 */
package cn.com.higinet.tms35.manage.ac.service.impl;
...
import cn.com.higinet.tms35.manage.ac.service.AcService;
...
public class AcServiceImpl implements AcService {
	...
	private static Log log = LogFactory.getLog(AcServiceImpl.class);
	@Autowired
	...
	/* (non-Javadoc)
	 * @see cn.com.higinet.tms35.manage.action.controller.service.ActionService#pageAction(java.util.Map)
	 */
	...
	/* (non-Javadoc)
	 * @see cn.com.higinet.tms35.manage.action.controller.service.ActionService#saveAc(java.util.List)
	 */
	@Transactional
	...
	private void checkDuplicateAcName(Map <String,Object> cond) {
		...
		String sql = "SELECT a.* FROM TMS_COM_RULE_ACTION a WHERE ac_desc=? " +
			"and RULE_ID=?";
	...
	/* (non-Javadoc)
	 * @see cn.com.higinet.tms35.manage.action.controller.service.ActionService#getOneAction(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see cn.com.higinet.tms35.manage.action.controller.service.ActionService#updateValidAc(java.lang.String[], java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see cn.com.higinet.tms35.manage.action.controller.service.ActionService#updateAcCond(java.util.Map)
	 */
