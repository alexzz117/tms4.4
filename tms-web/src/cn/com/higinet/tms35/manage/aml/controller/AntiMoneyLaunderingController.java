package cn.com.higinet.tms35.manage.aml.controller;
...
public class AntiMoneyLaunderingController {
	...
	public Model getAMLConfigAction(@RequestParam Map<String, Object> reqs) {
	...
	public Model getTxnModelFieldsAction(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
		model.setRow(antiMoneyLaunderingService.queryAmlConfig(reqs));
	...
	public Model saveAMLConfigAction(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model amlListAction(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model generateMessage(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model exportListAction(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model queryMessageInfo(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model editMessage(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model queryStifInfo(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model editStif(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model messageSync(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public Model updateGroup(@RequestParam Map<String, Object> reqs) {
		Model model = new Model();
	...
	public void messageExport(@RequestParam Map<String, Object> reqs, HttpServletResponse response) {
