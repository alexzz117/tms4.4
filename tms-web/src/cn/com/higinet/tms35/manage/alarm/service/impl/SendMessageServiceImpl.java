...
public class SendMessageServiceImpl implements SendMessageService {
	...
	private static Log log = LogFactory.getLog(SendMessageService.class);

	@Override
	public String sendMessage(Map<String, Object> transaction, String actionCode,
			List<Map<String, Object>> servList) {
