...
import cn.com.higinet.tms35.manage.mgr.util.MgrDateConvertUtil;
...
public class NameListServiceImpl implements NameListService {
	...
	private static Log log = LogFactory.getLog(NameListServiceImpl.class);
...
//	private DataSource tmpTmsDataSource;
	...
	public Page<Map<String, Object>> listNameList(Map<String, String> conds) {
		...
		sql.append("SELECT ROSTER.ROSTERID,ROSTER.ROSTERTYPE, ROSTER.DATATYPE, ROSTER.ROSTERNAME, ROSTER.ROSTERDESC, ROSTER.ISCACHE, ROSTER.CREATETIME, ROSTER.REMARK, " +
				           "(SELECT COUNT(1) FROM TMS_MGR_ROSTERVALUE ROSTERVALUE WHERE ROSTERVALUE.ROSTERID=ROSTER.ROSTERID) VALUECOUNT " +
				           "FROM TMS_MGR_ROSTER ROSTER " +
				           "WHERE STATUS!='2'");
	...
	public Map<String, Object> selectByValueId(String rosterValueId) {
		return getSimpleDao().retrieve(DBConstant.TMS_MGR_ROSTERVALUE, MapWrap.map(
				"ROSTERVALUEID", rosterValueId).getMap());
	}
	/**
	 * 根据rosterValueId查询名单值
	 * @param rosterValueId
...
//		checkRosterRefTmp(delList);
		...
		String[] sql = new String[] {rosterSql,rosterValueSql};
...
//	}
	...
	public Map<String, Object> getOneValueList(String rosterValueId) {
		...
		String sql = "select rostervalue.* " +
				"from TMS_MGR_ROSTERVALUE rostervalue " +
				"where rostervalue.ROSTERVALUEID = :rostervalueId";
...
//	public void deleteValueList(String[] valueIds) {
	public void deleteValueList(Map<String,List<Map<String,String>>> batchMap) {
		...
		String[] sql = new String[] {rosterValueSql};
		getSimpleDao().batchUpdate(sql);
...
//		}
	 ...
	 */
	private Map<String, ?> generateRosterValue(String value,
			String remark, String enabletime, String disabletime,
			String rosterId, String rosterDesc) throws ParseException {
	 ...
	 * @throws ParseException
	 */
	private String checkRosterValue(String value, String remark, String enabletime,
			String disabletime, String datatype, int rowNum) {
		String error = null;
		//非空验证
...
//	}
	...
	public List<Map<String, Object>> listValueListById(Map<String, String> conds) {
		String sql ="SELECT ROSTER.ROSTERDESC,ROSTERVALUE.ROSTERVALUE,ROSTERVALUE.ENABLETIME,ROSTERVALUE.DISABLETIME,ROSTERVALUE.REMARK"+
				" FROM TMS_MGR_ROSTERVALUE ROSTERVALUE,TMS_MGR_ROSTER ROSTER"+
				" WHERE ROSTERVALUE.ROSTERID=ROSTER.ROSTERID AND ROSTERVALUE.ROSTERID="+conds.get("rosterId");
	...
	public boolean isDuplicateByRosterAndTransAttr(String rosterName) {
		String sql = "select 1 from " + TMS_COM_FD.TABLE_NAME + " fd inner join " + TMS_COM_TAB.TABLE_NAME
				+ " tab on fd." + TMS_COM_FD.TAB_NAME + " = tab." + TMS_COM_TAB.TAB_NAME + " where fd." 
				+ TMS_COM_FD.REF_NAME + " = ? and tab." + TMS_COM_TAB.TAB_TYPE + " = '4'";
