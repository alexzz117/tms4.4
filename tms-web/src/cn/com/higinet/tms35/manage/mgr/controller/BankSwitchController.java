...
public class BankSwitchController {
	...
	public Model listBankSwitchListActoin(@RequestParam Map<String, String> reqs){
	...
	public Model delBankSwitchListActoin(@RequestParam Map<String, String> reqs) {
		Model model = new Model();
	...
	public Model addBankSwitchListActoin(@RequestParam Map<String, String> reqs,HttpServletRequest request) {
		Model model = new Model();
	...
	public Model getBankSwitchById(@RequestParam Map<String, String> reqs) {
		Model model = new Model();
	...
	public Model updateBankSwitchById(@RequestParam Map<String, String> reqs,HttpServletRequest request) {
		Model model = new Model();
	...
	public Model listBankSwitchHisById(@RequestParam Map<String, String> reqs){
		Model model = new Model();
