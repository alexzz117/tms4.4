...
public interface TransModelService {
	...
	/**
	 * @see cn.com.higinet.tms35.manage.tran.
	 * service.impl.TransModelServiceImpl#getTranModels()
	 * @return
	 */
	...
	/**
	 * @see cn.com.higinet.tms35.manage.tran.
	 * service.impl.TransModelServiceImpl#getCanRefTable()
	 * @return
	 */
	public List<Map<String, Object>> getCanRefTable();
	/**
	 * @see cn.com.higinet.tms35.manage.tran.
	 * service.impl.TransModelServiceImpl#getFunc()
	 * @return
	 */
