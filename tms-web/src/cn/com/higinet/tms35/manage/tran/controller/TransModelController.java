...
public class TransModelController {
	...
	public Model initTranModel(@RequestParam Map<String, String> reqs) {
		...
		model.set("enableStoreFd", queryAvailableStoreFd(txnid).get("enableStoreFd"));
	...
	public Model initTranModeOf(@RequestParam Map<String, String> reqs) {
	...
	public Model getCanRefFd(@RequestParam String tab_name) {
	...
	public Model queryAvailableStoreFd(@RequestParam String tab_name) {
		
		Model model = new Model();
		model.set("enableStoreFd", transModelService.getAvailableStoreFd(tab_name));
		return model;
	}
	...
	public Model saveModel(@RequestParam Map<String, String> reqs) {
	...
	public Model saveModelRefTab(@RequestParam Map<String, String> reqs) {
	...
	public Model saveModelRefFd(@RequestParam Map<String, String> reqs) {
	...
	public Model getTransByTabnameList(@RequestParam Map<String, String> reqs) {
		Model model = new Model();
	...
	public Model getTrandataList(@RequestParam Map<String, String> reqs) {
		Model model = new Model();
		try {
