 ...
 * All right reserved.
 */
package cn.com.higinet.tms35.manage.userpattern.controller;
...
@RequestMapping("/tms35/userpattern")
public class UserpatternController {
	...
	public String listUserpatternAction() {
		return "/tms35/userpattern/stat_list";
	}
	...
	public String userListAction() {
		return "/tms35/userpattern/user_list";
	}
	...
	public String userPatternListAction() {
		return "/tms35/userpattern/userpattern_list";
	}
