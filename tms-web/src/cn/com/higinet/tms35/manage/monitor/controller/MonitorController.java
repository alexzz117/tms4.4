package cn.com.higinet.tms35.manage.monitor.controller;
...
import cn.com.higinet.rapid.base.common.CodeDict;
...
import cn.com.higinet.tms35.manage.monitor.service.AlarmService;
...
public class MonitorController extends ApplicationObjectSupport {
	...
	public Model listRuleActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		Page<Map<String, Object>> dataPage = (Page<Map<String, Object>>) getMonitorData(reqs, new String[] {
				StaticParameters.S_TMS_MONITOR_RULE_TEMP_CHART, StaticParameters.S_TMS_MONITOR_RULE_HOUR_CHART}, null, true);
	...
	public Model listRuleChartActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		List<String> list = new ArrayList<String>();
		List<Map<String,Object>> dataList = (List<Map<String,Object>>) getMonitorData(reqs, new String[] {
				StaticParameters.S_TMS_MONITOR_RULE_TEMP_CHART, StaticParameters.S_TMS_MONITOR_RULE_HOUR_CHART}, null, false);
	...
	public Model listTxnActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		String extSql = getTrafficExtSql(reqs);
		Page<Map<String, Object>> dataPage = (Page<Map<String, Object>>) getMonitorData(reqs, new String[] {
				StaticParameters.S_TMS_MONITOR_TXN_TEMP_CHART, StaticParameters.S_TMS_MONITOR_TXN_HOUR_CHART}, extSql, true);
	...
	public Model listFraudActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		String extSql = "";
//		List<String> list = new ArrayList<String>();
		Page<Map<String, Object>> dataPage = (Page<Map<String, Object>>) getMonitorTmpData(reqs, new String[] {
				StaticParameters.S_TMS_MONITOR_FRAUD_TEMP_CHART, StaticParameters.S_TMS_MONITOR_FRAUD_HOUR_CHART}, extSql, true);
	...
	public Model listMapActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
//		List<String> list = new ArrayList<String>();
	...
	public Model listTxnChartActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		String extSql = getTrafficExtSql(reqs);
		List<String> list = new ArrayList<String>();
		List<Map<String,Object>> dataList = (List<Map<String,Object>>) getMonitorData(reqs, new String[] {
				StaticParameters.S_TMS_MONITOR_TXN_TEMP_CHART, StaticParameters.S_TMS_MONITOR_TXN_HOUR_CHART}, extSql, false);
	...
	public Model listAlertActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		List<String> list = new ArrayList<String>();
		List<Map<String, Object>> dataList = (List<Map<String, Object>>) getMonitorData(reqs, 
				new String[] {StaticParameters.S_TMS_MONITOR_ALERT_CHART}, null, false);
	...
	public Model listStActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		List<String> list = new ArrayList<String>();
		List<Map<String, Object>> dataList = (List<Map<String, Object>>) getMonitorData(reqs, new String[] {
				StaticParameters.S_TMS_MONITOR_RISK_TEMP_CHART, StaticParameters.S_TMS_MONITOR_RISK_HOUR_CHART}, null, false);
	...
	public Model oneRuleActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
		List<String> list = new ArrayList<String>();
	...
	public Model listAllCountryAction(@RequestParam Map<String, String> reqs){
		Model model = new Model();
	...
	public Model listRegionAction(@RequestParam Map<String, String> reqs){
	...
	public Model listCityAction(@RequestParam Map<String, String> reqs){
	...
	private Object getMonitorTmpData(Map<String, String> reqs, String[] sqlNames, String extSql, boolean isPage){
		...
		if(!StringUtil.isBlank(frm) && (sqlNames != null && sqlNames.length == 2)){
			if(frm.equals("currentTime")){
				addTmpCond(conds);
...
//			data.put("TXNALERTRATE", MapUtil.getString(data, "TXNALERTRATE")+"%");
	...
	private String getRMRuleChart(List<Map<String,Object>> dataList, Map<String, String> reqs){
		...
		Object[] params = {};
		String chartData = getApplicationContext().getBean("gradientAngularFusionChart",
	...
	private String getRMTrafficChart(List<Map<String,Object>> dataList){
		...
		Object[] params = {};
		String chartData = getApplicationContext().getBean("column2DFusionChart",
				FusionChart.class).generateChart(fChartVO,params);
		return chartData;
	}
	...
	private String getRMRiskChart(List<Map<String,Object>> dataList,Map<String, String> reqs){
		...
		String chartData = getApplicationContext().getBean("stackedBar2DFusionChart",
				FusionChart.class).generateChart(fChartVO,params);
		return chartData;
	}
	...
	private String getRMAlertChart(List<Map<String,Object>> dataList,Map<String, String> reqs){
		...
		Object[] params = {tempList};	//传递时间刻度参数
		String chartData = getApplicationContext().getBean("scrollLine2DFusionChart",
				FusionChart.class).generateChart(fChartVO,params);	//返回图表xml，前端解析成图表
	...
	private String getTimeScope(Map<String, String> conds){
		int scope = 1;
		String temp = "";
		if(!("".equalsIgnoreCase(MapUtil.getString(conds,"frm")))
					&&MapUtil.getString(conds,"frm")!=null){
