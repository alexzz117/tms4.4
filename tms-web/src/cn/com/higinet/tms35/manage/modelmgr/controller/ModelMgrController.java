package cn.com.higinet.tms35.manage.modelmgr.controller;
...
import cn.com.higinet.tms35.manage.modelmgr.service.ModelMgrService;
...
public class ModelMgrController {
	...
	public Model modelMgrLisActoin(@RequestParam Map<String, String> reqs){
	...
	public Model mcLisActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
	...
	public Model mhListActoin(@RequestParam Map<String, String> reqs){
		Model model = new Model();
	...
	public Model mTrainActoin(@RequestParam String[] txnids){
		Model model = new Model();
		String t = "";
	...
	private Map<String, byte[]> getMessage(String refreshMsg) {
		...
		try {
			...
			body.append(StringUtil.appendXmlMessage("TXNID", refreshMsg));
			body.append(StringUtil.appendXmlMessage("TRAINTYPE", "1"));// 0：自动训练，1：手工训练
			body.append("</Message>");
