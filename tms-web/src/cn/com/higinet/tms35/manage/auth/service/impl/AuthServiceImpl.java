package cn.com.higinet.tms35.manage.auth.service.impl;
...
import cn.com.higinet.cmc.util.AuthDataBusUtil;
...
import cn.com.higinet.tms35.manage.aop.cache.common.ParseCacheConfigXml;
import cn.com.higinet.tms35.manage.auth.common.AuthStaticParameters;
import cn.com.higinet.tms35.manage.auth.common.ParseTableConfigXML;
import cn.com.higinet.tms35.manage.auth.common.TableConfig;
import cn.com.higinet.tms35.manage.auth.service.AuthService;
...
import cn.com.higinet.tms35.manage.datamgr.DataOperCenter;
import cn.com.higinet.tms35.manage.datamgr.common.ConfigAttrabute;
import cn.com.higinet.tms35.manage.mgr.service.NameListService;
...
public class AuthServiceImpl extends ApplicationObjectSupport implements AuthService {
	...
	public Page<Map<String, Object>> dataList(Map<String, String> conds) {
		String sql = "SELECT AUTH.*, "
				...
				" AUTH.operatedata_value DATAVALUE, " + "(SELECT AUTHRECORD.OPERATE_NAME FROM TMS_MGR_AUTHRECORD AUTHRECORD WHERE AUTHRECORD.AUTH_ID = AUTH.AUTH_ID AND AUTHRECORD.IS_MAIN=1) OPERATENAME, "
	...
	public Page<Map<String, Object>> authLogList(Map<String, String> reqs) {
		String sql = "SELECT LOG.*," + " OPER.REAL_NAME,OPER.LOGIN_NAME,FUNC.FUNC_NAME" + " FROM CMC_OPERATE_LOG LOG LEFT JOIN CMC_OPERATOR OPER ON LOG.OPERATOR_ID = OPER.OPERATOR_ID" + " LEFT JOIN TMS_MGR_AUTHLOG AUTHLOG ON AUTHLOG.LOG_ID = LOG.PRIMARY_KEY_ID"
				+ " LEFT JOIN CMC_FUNC FUNC ON FUNC.FUNC_ID = LOG.FUNC_ID" + " WHERE LOG.PRIMARY_KEY_ID IN (SELECT AUTHLOG.LOG_ID FROM TMS_MGR_AUTHLOG AUTHLOG WHERE AUTHLOG.AUTH_ID = :AUTH_ID)";
		Map<String, Object> conds = new HashMap<String, Object>();
	...
	public void aopCreateAuthRecord(Map<String, Object> authRecord) {
		authRecord.put("RECORD_ID", IdUtil.uuid());
	...
	public Map<String, Object> getAuthInfoByQueryPkValue(String queryPkvalue, MethodConfig mc) {
		...
		String sql = "SELECT * FROM TMS_MGR_AUTHINFO AUTHINFO" + " WHERE AUTHINFO.MODULE_ID =:MODULE_ID AND AUTHINFO.AUTH_STATUS = '0' AND AUTHINFO.QUERY_PKVALUE=:QUERY_PKVALUE " + "AND AUTHINFO.QUERY_TABLE_NAME =:QUERY_TABLE_NAME"
				+ " AND AUTHINFO.QUERY_TABLE_PK =:QUERY_TABLE_PK";
		Map<String, String> conds = new HashMap<String, String>();
	...
	public String[] getTmpUserPatternName(String userId, String statId, String patternValue) {
		...
		String[] result = { statTxn, "(客户号：" + userId + ")-(统计描述：" + statdesc + ")-(行为习惯值：" + patternValue + ")" };
		return result;
	}
	...
	class RefreshNameListCacheTask implements Runnable {
		...
		public void run() {
			...
			if (authInfoSet == null || authInfoSet.isEmpty())
				return;
