...
import cn.com.higinet.tmsreport.web.common.ReportCompare;
...
import cn.com.higinet.tmsreport.web.common.RptDBConstant;
import cn.com.higinet.tmsreport.web.service.DisposalService;
import cn.com.higinet.tmsreport.web.service.TxnReportService;
...
//			String disposal = MapUtil.getString(map, "DISPOSAL");
	...
	public String getChartData(List<Map<String, Object>> dataList,Map<String, String> conds) {
		Map<String,Object> sql_conds = new HashMap<String, Object>();
		String target = StringUtil.isBlank(conds.get("target")) ? "TXNNUMBER" : conds.get("target");
