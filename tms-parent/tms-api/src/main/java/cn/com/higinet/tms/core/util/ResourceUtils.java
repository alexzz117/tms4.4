...
public abstract class ResourceUtils {
	...
	public static URL getURL(String resourceLocation) throws FileNotFoundException {
		ResourceUtils.notNull(resourceLocation, "Resource location must not be null");
		if (resourceLocation.startsWith(CLASSPATH_URL_PREFIX)) {
			String path = resourceLocation.substring(CLASSPATH_URL_PREFIX.length());
			URL url = ResourceUtils.getDefaultClassLoader().getResource(path);
			if (url == null) {
	 ...
	 *            the resource URL to resolve
	 * @param description
	 *            a description of the original resource that the URL was created for (for example, a class path location)
	 * @return a corresponding File object
	 * @throws FileNotFoundException
	 *             if the URL cannot be resolved to a file in the file system
	 */
	public static File getFile(URL resourceUrl, String description) throws FileNotFoundException {
		ResourceUtils.notNull(resourceUrl, "Resource URL must not be null");
	 ...
	 *            the resource URI to resolve
	 * @param description
	 *            a description of the original resource that the URI was created for (for example, a class path location)
	 * @return a corresponding File object
	 * @throws FileNotFoundException
	 *             if the URL cannot be resolved to a file in the file system
	 */
	public static File getFile(URI resourceUri, String description) throws FileNotFoundException {
		ResourceUtils.notNull(resourceUri, "Resource URI must not be null");
	...
	// added by wujw 2015-09-24
	public static String getPropPath(String path) {
		String p = null;
		try {
	...
	public static void main(String args[]) {
		String path = ResourceUtils.getPropPath("classpath:properties");
