 ...
 * @since:  v4.3
 */
public class OverLengthException extends BaseRuntimeException {

	/**
	 * @see BaseRuntimeException#BaseRuntimeException(String)
	 */
	public OverLengthException(String msg) {
		super(msg);
	}
	 ...
	 */
	public OverLengthException(Throwable ex) {
		super(ex);
	}
	 ...
	 */
	public OverLengthException(String msg, Throwable ex) {
		super(msg, ex);
	}
	 ...
	 */
	public OverLengthException(String msg, Object... args) {
		super(msg, args);
	}
}
