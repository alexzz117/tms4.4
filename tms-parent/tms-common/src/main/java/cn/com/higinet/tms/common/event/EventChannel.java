 ...
 * 每个通道有且只有一个{@link cn.com.higinet.tms.common.event.EventChannelHandler}。
 * 目前EventChannel的实现有两个类，跟事件总线{@link cn.com.higinet.tms.common.event.EventBus}类似，通道的两个实现一个是基于
 * 多线程的实现{@link cn.com.higinet.tms.common.event.impl.ConcurrentEventChannel}，另外一个是基于单线程的实现{@link cn.com.higinet.tms.common.event.impl.SimpleEventChannel}，
 ...
 * 		因此搭配{@link cn.com.higinet.tms.common.event.impl.ConcurrentEventChannel}使用的时候要注意，ConcurrentEventChannel
 ...
 * 
 * 新增{@link cn.com.higinet.tms.common.event.impl.DisruptorEventChannel}disruptor通道，跟ConcurrentEventChannel一样，属于异步通道，
