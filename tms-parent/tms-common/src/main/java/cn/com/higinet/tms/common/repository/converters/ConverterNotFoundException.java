...
public class ConverterNotFoundException extends BaseRuntimeException {
	 ...
	 */
	public ConverterNotFoundException(Throwable ex) {
		super(ex);
	}
	 ...
	 */
	public ConverterNotFoundException(String msg, Throwable ex) {
		super(msg, ex);
	}
	 ...
	 */
	public ConverterNotFoundException(String msg, Object... args) {
		super(msg, args);
	}
}
