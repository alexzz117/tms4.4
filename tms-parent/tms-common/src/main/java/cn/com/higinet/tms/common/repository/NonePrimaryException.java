 ...
 * @since:  v4.3
 */
public class NonePrimaryException extends BaseRuntimeException {

	/**
	 * @see BaseRuntimeException#BaseRuntimeException(String)
	 */
	public NonePrimaryException(String msg) {
		super(msg);
	}
	 ...
	 */
	public NonePrimaryException(Throwable ex) {
		super(ex);
	}
	 ...
	 */
	public NonePrimaryException(String msg, Throwable ex) {
		super(msg, ex);
	}
	 ...
	 */
	public NonePrimaryException(String msg, Object... args) {
		super(msg, args);
	}
}
