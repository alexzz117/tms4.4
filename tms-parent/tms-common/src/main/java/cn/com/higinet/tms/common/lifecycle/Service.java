...
/**
 * 抽象的服务对象，此对象实现了生命周期对象 {@link cn.com.higinet.tms.common.lifecycle.Lifecycle}，
...
public abstract class Service implements Lifecycle, Sortable {
	...
	/**
	 * @see cn.com.higinet.tms.common.lifecycle.Lifecycle#start()
	 */
	...
	/**
	 * @see cn.com.higinet.tms.common.lifecycle.Lifecycle#suspend()
	 */
	...
	/**
	 * @see cn.com.higinet.tms.common.lifecycle.Lifecycle#resume()
	 */
	...
	/**
	 * @see cn.com.higinet.tms.common.lifecycle.Lifecycle#stop()
	 */
	public boolean stop() {
		if (!isEnable()) {
			return false;
