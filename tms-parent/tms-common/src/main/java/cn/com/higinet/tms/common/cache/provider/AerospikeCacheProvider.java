...
import cn.com.higinet.tms.common.cache.adapter.AerospikeCacheAdapter;
...
public class AerospikeCacheProvider extends AbstractCacheProvider {
	...
	/**
	 * @see cn.com.higinet.tms.common.cache.provider.AbstractCacheProvider#getCache()
	 */
	@Override
	...
	protected void doStart() throws Throwable {
		...
		if(StringUtils.isNull(host)){
			throw new NullParamterException("configer param \"host\" can not be null for Aerospike id =\"%s\"",cacheEnv.getCacheId());
		}
