 ...
 * @since:  v4.3
 */
public class ConvertValueException extends BaseRuntimeException {

	/**
	 * @see BaseRuntimeException#BaseRuntimeException(String)
	 */
	public ConvertValueException(String msg) {
		super(msg);
	}
	 ...
	 */
	public ConvertValueException(Throwable ex) {
		super(ex);
	}
	 ...
	 */
	public ConvertValueException(String msg, Throwable ex) {
		super(msg, ex);
	}
	 ...
	 */
	public ConvertValueException(String msg, Object... args) {
		super(msg, args);
	}
}
