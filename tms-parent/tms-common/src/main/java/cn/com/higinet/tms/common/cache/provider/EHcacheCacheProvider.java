...
import cn.com.higinet.tms.common.cache.adapter.EHCacheCacheAdapter;
...
public class EHcacheCacheProvider extends AbstractCacheProvider {
	...
	protected void doStart() throws Throwable {
		...
		if (StringUtils.isNull(diskDir)) {
			throw new NullParamterException("Configuration \"diskDir\" can not be null for EHCache id=\"%s\"", cacheName);
		}
