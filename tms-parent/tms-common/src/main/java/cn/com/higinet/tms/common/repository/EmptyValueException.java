 ...
 * @since:  v4.3
 */
public class EmptyValueException extends BaseRuntimeException {
	 ...
	 */
	public EmptyValueException(Throwable ex) {
		super(ex);
	}
	 ...
	 */
	public EmptyValueException(String msg, Throwable ex) {
		super(msg, ex);
	}
	 ...
	 */
	public EmptyValueException(String msg, Object... args) {
		super(msg, args);
	}
}
