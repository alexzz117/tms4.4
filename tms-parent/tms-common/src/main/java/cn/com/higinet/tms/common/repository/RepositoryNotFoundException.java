 ...
 * @since:  v4.3
 */
public class RepositoryNotFoundException extends BaseRuntimeException {
	 ...
	 */
	public RepositoryNotFoundException(Throwable ex) {
		super(ex);
	}
	 ...
	 */
	public RepositoryNotFoundException(String msg, Throwable ex) {
		super(msg, ex);
	}
	 ...
	 */
	public RepositoryNotFoundException(String msg, Object... args) {
		super(msg, args);
	}
}
