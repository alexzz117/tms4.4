<template>
  <div>
    <div style="margin-bottom: 10px;text-align: left ">
      ...
      <el-button plain class="el-icon-plus" @click="auth" :disabled="notSelectOne">授权</el-button>
      <el-button plain class="el-icon-edit" @click="showSub" :disabled="notSelectOne">查看子操作</el-button>
      <el-button plain class="el-icon-delete" @click="showLog()" :disabled="notSelectOne">查看日志</el-button>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      toCompare (row) {
        ...
        this.$router.replace({name: 'AuthDataCompare', query: params})
        console.log(row)
      },
      getData () {
        let self = this
      ...
      back () {
        this.$router.replace({name: 'AuthCenter'})
      }
    }
  }
</script>
